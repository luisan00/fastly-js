...
[![Coverage Status](https://coveralls.io/repos/github/luisan00/fastly-lib/badge.svg?branch=develop)](https://coveralls.io/github/luisan00/fastly-lib?branch=develop)
### Requirements
Node.js >= 4.8.4
